...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#fff9f1fff9f1]"
    >
          ...
          >
            ...
            <div className="flex space-x-5 pb-3">
              ...
              <a
                ...
                aria-label="LeetCode"
              >
                <CodeXml className="w-5 h-5 text-gray-700 group-hover:text-blue-600 transition-colors" />
              </a>
            </div>

          </div> {/* ✅ Fixed: closing tag for Left Content */}
